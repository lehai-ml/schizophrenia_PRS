...
random_graph_generator=graph_analysis.yield_perm_matrices_volumetric_data(X,1000,np.linspace(1,30,30),diffusion_data=True)
...
for _ in tqdm.tqdm(range(300)):
    try:
        ...
        for threshold in tqdm.tqdm(range(30)):
            temp_path_low_risk='./log/perm_graph_metrics_low_risk_diffusion_vm1_run1.txt'
            ...
            temp_path_high_risk='./log/perm_graph_metrics_high_risk_diffusion_vm1_run1.txt'
